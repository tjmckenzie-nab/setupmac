...
```
curl -s https://raw.githubusercontent.com/tjmckenzie-nab/setupmac/master/start.sh | /bin/bash
```
...
what get's installed at [here](https://raw.githubusercontent.com/tjmckenzie-nab/setupmac/master/roles/setup/vars/main.yml). If you want to change the list of applications, clone
